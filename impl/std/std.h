...
struct ldr_data_table_entry_t {
    list_entry_t m_in_load_order_module_list;        // +0x00  (16 bytes, two pointers)
    list_entry_t m_in_memory_order_module_list;      // +0x10
    list_entry_t m_in_initialization_order_module_list; // +0x20
...
using nt_continue_t = NTSTATUS( NTAPI* )( PCONTEXT ContextRecord, bool TestAlert );